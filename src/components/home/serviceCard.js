...
export default function ServiceCard({ title, description, path }) {
  ...
  return (
    <div className="flex flex-col items-start space-y-2 md:space-y-7 max-w-3xl">
      <h1 className="text-3xl te max-md:text-left text-orange_1">{title}</h1>
      <p className="max-md:text-justify">{description}</p>
