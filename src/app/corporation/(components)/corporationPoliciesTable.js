...
export default function CorporationPoliciesTable() {
  ...
  useEffect(() => {
    startTransition(async () => {
      ...
      const folderId = "corporation/policies";
      ...
      if (error) {
        console.error(
          "Erreur lors du chargement des proces verbaux et politiques:",
          error,
        );
        return;
      }
